    ...
    return (
        <div
            className={`${styles.main_wrap} ${
                open ? styles.mobile_background : undefined
            }`}
        >
            <Head>
            ...
            <div className={`${styles.info} ${open ? styles.hide : undefined}`}>
                <img
                    src="/images/mobile/image-interactive.jpg"
                    alt="image"
                    className={styles.picture_mobile}
                />

                <img
                    src="/images/desktop/image-interactive.jpg"
                    alt="image"
                    className={styles.picture_desktop}
                />
            ...
            >
                <div className={styles.wrap}>
                    ...
                    <div className={styles.grid_mobile}>
                        <Image
                            image={
                                <img
                ...
                <div className={styles.grid_desktop}>
                    <Image
                        image={
                            <img
            ...
            <footer
                className={`${styles.footer} ${open ? styles.hide : undefined}`}
            >
